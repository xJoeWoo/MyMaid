...
public class SingleUser extends Activity implements PullToRefreshAttacher.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                Intent ii = new Intent(SingleUser.this, SingleWeibo.class);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case GOT_SHOW_INFO_FAIL: {
                    if (msg.obj != null) {
                        Toast.makeText(SingleUser.this, ((ErrorBean) msg.obj).getError(), Toast.LENGTH_SHORT)
                                .show();
                        finish();
                    } else {
    ...
    private void setListView(ArrayList<HashMap<String, String>> arrayList) {
        mAdapter = new MyMaidAdapter(SingleUser.this, arrayList);
    ...
    private void refreshTimeLine() {
        if (uid == null) {
            ...
            new Weibo_UserTimeLine(screenName, Weibo_AcquireCount.SINGLE_USER_TIMELINE_COUNT, mHandler).start();
            new Weibo_UserShow(screenName, mHandler).start();
        } else {
            Log.e(TAG, "UID: " + uid);
            new Weibo_UserTimeLine(uid, Weibo_AcquireCount.SINGLE_USER_TIMELINE_COUNT, mHandler).start();
            new Weibo_UserShow(uid, mHandler).start();
        }
    }
}
